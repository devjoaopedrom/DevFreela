...
namespace DevFreela.Application.Models
{
    ...
    {
        public ProjectViewModel(int id, string title, string description, int idClient, int ìdFreelancer, string clientName, string freelancerName, decimal totalCost, List<ProjectComment> comments)
        {
            Id = id;
            Title = title;
            Description = description;
            IdClient = idClient;
            ÌdFreelancer = ìdFreelancer;
        ...
        public int ÌdFreelancer { get; private set; }
